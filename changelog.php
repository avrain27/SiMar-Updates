...
- attempts...
- Now fixed with version 0.2.3.5!! (slimstat confliction resolved)
...
Moved Bootstrapp CSS back to header. Code left in footer if needed
|==== Version 0.1.0.0 =====|
...
css include tweaks
|==== Version 0.0.8.4 =====|
Reversed async/defer on scripts
|==== Version 0.0.8.3 =====|
Changes that hopefully work...
|==== Version 0.0.8.2 =====|
